...
class EmployeeController {
    ...
    /* since Grails 2.0.2 exclude properties which are static, transient or dynamically typed*/
    def updateEmployeeNaiveWay() {
        def employee = Employee.get(params.id as Integer)
    ...
    def updateEmployeeBindDataInclude() {
        def employee = Employee.get(params.id as Integer)
    ...
    def updateEmployeeBindDataExclude() {
        def employee = Employee.get(params.id as Integer)

        bindData(employee,params,[exclude:['salary']])
    ...
    def test() {
        ...
        render view: "test", model: [badParam: params.badParam]
    }
}
